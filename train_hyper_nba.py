...
parser.add_argument('--ztype', default='gaussian', choices=['gaussian', 'skew', 'top1skew'])
...
args.model_save_dir = f'{args.model_save_dir}/{args.ztype}_{args.date}'
...
for epoch in range(args.epoch_continue, args.num_epochs):
    ...
    if  loss < loss_best:
        ...
        saved_path = f'{args.model_save_dir}/model.p'
